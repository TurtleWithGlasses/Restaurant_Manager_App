...
def create_invoice():
    ...
    invoice_text.insert(END, f"*"*60 + "\n")
    invoice_text.insert(END, f"Items\t\tQuantitiy\tItems Cost\n")
    ...
    for de in dessert_text:
        if de.get() != "0":
            invoice_text.insert(END, f"{dessert_list[x]}\t\t{de.get()}\t"
                                    f"$ {int(de.get())*dessert_price[x]}\n")
        x += 1
    ...
    invoice_text.insert(END, f"Thanks for coming!")
...
# window size
application.geometry("1300x800+0+0")

# prevent from maximizing
application.resizable(False, False)

# windows title
application.title("Kardeşler Lokantası")

# window background color
application.config(bg="brown3")
...
# product lists
food_list = ["Chicken","Lamb","Salmon","Hake","Kebabs","Pizza","Hamburger","Steak"]
drink_list = ["Water","Lemonade","Soda","Juice","Coke","Beer","Wine","Whiskey"]
dessert_list = ["Pie","Cake","Brownie","Ice Cream","Pudding","Cheesecake", "Apple Pie","Chocolate Cake"]
...
for dessert in dessert_list:
    ...
    food_cost_label = Label(cost_panel,
                            ...
                            bg="azure4",
                            fg="white")
    food_cost_label.grid(row=0,column=0, padx=41)
    ...
    food_cost_text.grid(row=1,column=1, padx=41)
    ...
    drink_cost_label = Label(cost_panel,
                            ...
                            bg="azure4",
                            fg="white")
    drink_cost_label.grid(row=1,column=0, padx=41)
    ...
    drink_cost_text.grid(row=0,column=1, padx=41)
    ...
    taxes_cost_label = Label(cost_panel,
                            ...
                            bg="azure4",
                            fg="white")
    taxes_cost_label.grid(row=1,column=2, padx=41)
